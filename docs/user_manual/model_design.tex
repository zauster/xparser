...
\begin{figure}[ht]
\begin{center}
\includegraphics*[scale=0.5]{iteration_1.ps}
...
Describing a system would thus include the following individual stages for creating a model:
...
%Future work would also allow the lower level description of functions that
